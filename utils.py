...
def save_image(pred_image, image_name, exp_name, category):
    ...
    image_name_1 = image_name[0].split('/')[-1]
 
    batch_num = len(pred_image_images)
    vutils.save_image(pred_image, './resultscvpr/{}/{}/{}'.format(category, exp_name, image_name_1))
...
def adjust_learning_rate(optimizer, epoch, num_epochs, init_lr):
    # --- Decay learning rate --- #
    step = 100
